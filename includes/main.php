        ...
        <div class="pn-option-setting">
            ...
            <script type="text/javascript">
                window.pnData = {
                    ...
                    nodes: <?php echo wp_json_encode($nodes); ?>,
                    edges: <?php echo wp_json_encode($edges); ?>,
                    visConfig: {
                        main: <?php echo wp_json_encode($this->pn_set_options_main()); ?>,
                        configure: <?php echo wp_json_encode($this->pn_set_options_configure()); ?>,
                        edges: <?php echo wp_json_encode($this->pn_set_options_edges()); ?>,
                        groups: <?php echo wp_json_encode($this->pn_set_options_groups()); ?>,
                        interaction: <?php echo wp_json_encode($this->pn_set_options_interaction()); ?>,
                        layout: <?php echo wp_json_encode($this->pn_set_options_layout()); ?>,
                        manipulation: <?php echo wp_json_encode($this->pn_set_options_manipulation()); ?>,
                        nodes: <?php echo wp_json_encode($this->pn_set_options_nodes()); ?>,
                        physics: <?php echo wp_json_encode($this->pn_set_options_physics()); ?>
                    }
                };
            </script>
        </div>
